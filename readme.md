...
[![OhScrap][MOD:shd:latest]][forum] [![KSP version][KSP:shd]][KSP:url]  [![License][LIC:shd]][LIC:url]  
...
>
> HELP WANTED - See the [README in the Localization folder][lreadme] or the [Quickstart Guide][qstart] for instructions for adding or improving translations. [GitHub][GitHub:url]
...
* [ScrapYard (SYD)][SYD] to keep track of how many times a part has been built/recovered so that is a hard dependency. (obtained separately)
* Either [^3]
...
* [Kerbal Construction Time][kct] designed with this with in mind, so would recommend that mod (make sure you use the latest dev version)
* [StageRecovery][sr] If you plan to actually re-use your parts (and have them fail), you'll probably want StageRecovery too
* [KRASH][krash]
...
* [`severedsolo`][severedsolo] for creating this glorious bad-day plugin!
...
#### Previous (1) - Author: [`zer0Kerbal`][zer0Kerbal]
...
*and it is true.*
<!-- mod links -->
[attr]: https://zer0kerbal.github.io/OhScrap/Attributions "Attribution"
[chlog]: https://raw.githubusercontent.com/zer0Kerbal/OhScrap/master/changelog.md  "Changelog"
[discu]: https://github.com/zer0Kerbal/OhScrap/discussions "Discussions"
[forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/192360-*/ "OhScrap! Forum"
[issue]: https://github.com/zer0Kerbal/OhScrap/issues "Issues"
[markt]: https://zer0kerbal.github.io/OhScrap/Marketing "Marketing Slicks"
[notic]: https://zer0kerbal.github.io/OhScrap/Notices "Notices"
[pages]: https://zer0kerbal.github.io/OhScrap "GitHub Pages"
...
[MOD:0:dnload]: https://github.com/severedsolo/OhScrap "GitHub"
[MOD:0:source]: https://github.com/severedsolo/OhScrap "GitHub"
[MOD:0:thread]: https://forum.kerbalspaceprogram.com/index.php?/topic/160854-*/ "KSP Forum"

<!--- license provenance -->
[LIC:1:url]: https://creativecommons.org/licenses/by-nc-sa/4.0/ "Expat-MIT"
...
[SPCDCK:url]: http://spacedock.info/mod/2364 "SpaceDock"
...
[kct]: https://forum.kerbalspaceprogram.com/index.php?/topic/182877-*/ "Kerbal Consruction Time"
...
[usi-mk]: http://forum.kerbalspaceprogram.com/index.php?/topic/154587-*/ "USI MK"
...
Track progress: issues [here][issue] and projects [here](https://github.com/zer0Kerbal/OhScrap/projects/) along with **[The Short List](https://github.com/users/zer0Kerbal/projects/27)**
